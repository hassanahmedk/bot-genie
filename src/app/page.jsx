      ...
      <div className="flex py-28  ">
        <div className="flex flex-1 flex-col gap-6">
          ...
          <p className="text-lg leading-snug">
            Lorem Ipsum Sit amet Condor Lorem Ipsum Sit amet Condor Lorem Ipsum
            Sit amet Condor Lorem Ipsum Sit amet Condor
          </p>
        ...
        <div className="flex flex-1 justify-center items-center overflow-hidden relative h-full w-full">
          <Image alt="landing-illustration" src={'/images/dani/Visuals.png'} fill />
        </div>
      </div>
      {/* Features */}
      <div>
        ...
        <div className="flex gap-8 justify-between ">
          <div className="flex flex-col justify-center items-center bg-[#FFFFFF] px-10 py-8 gap-8 border rounded-3xl shadow-md">
            ...
            <button className="flex gap-2 items-center justify-center text-lg font-poppins font-extrabold text-[#009379] text-center">
              Learn More<img src={ArrowRight}></img>
            </button>
          </div>

          <div className="flex flex-col justify-center items-center bg-[#FFFFFF] px-10 py-8 gap-8 border rounded-3xl shadow-md">
            <div className="rounded-2xl bg-[#00937933] p-5">
              <img className="w-10 h-10" src={Icon1}></img>
            </div>
            <h1 className="text-3xl text-center font-popppins font-extrabold">
              Lorem Ipsum
            </h1>
          ...
          <div className="flex flex-col justify-center items-center bg-[#FFFFFF] px-10 py-8 gap-8 border rounded-3xl shadow-md">
            <div className="rounded-2xl bg-[#F8D57E33] p-5">
              <img className="w-10 h-10" src={Icon2}></img>
            </div>
            <h1 className="text-3xl text-center font-popppins font-extrabold">
              Lorem Ipsum
            </h1>
          ...
          <div className="max-w-sm w-full bg-white shadow-lg rounded-lg overflow-hidden m-4">
            ...
            <div className="p-6">
              <p className="text-3xl font-poppins font-extrabold">
                $9.99{" "}
                <span className="text-sm font-poppins font-normal">/month</span>
              </p>
              <ul className="mt-4">
